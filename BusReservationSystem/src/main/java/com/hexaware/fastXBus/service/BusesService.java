...
public class BusesService implements IBusesService {
	...
	public BusesDTO getBusById(Long busId) {
		...
		return new BusesDTO(buses.getBusId(),buses.getBusNumber(),buses.getCapacity(),buses.getSourceCity(),buses.getDestinationCity(),buses.getDistanceInKms(),buses.getDurationInHours(),buses.getDepartureTime(),buses.getFare(),buses.getDate());
	}
